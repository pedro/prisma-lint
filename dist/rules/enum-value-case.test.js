...
describe('enum-value-case', () => {
    ...
    describe('snake', () => {
        ...
        `);
                expect(violations.length).toEqual(1);
                expect(violations[0].message).toEqual("Enum value should be in snake_case: 'ForAPIKey' (expected 'for_api_key').");
            });
        });
    ...
    describe('camel', () => {
        ...
        `);
                expect(violations.length).toEqual(1);
                expect(violations[0].message).toEqual("Enum value should be in camelCase: 'ForAPIKey' (expected 'forAPIKey').");
            });
        });
        describe('with allowlist string', () => {
    ...
    describe('pascal', () => {
        ...
        `);
                expect(violations.length).toEqual(1);
                expect(violations[0].message).toEqual("Enum value should be in PascalCase: 'forAPIKey' (expected 'ForAPIKey').");
            });
        });
        describe('with allowlist string', () => {
            const run = getRunner({
