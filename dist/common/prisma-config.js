 ...
 */
export const findPrismaConfigFile = (startDir) => {
 ...
 */
export const loadPrismaConfig = async (startDir) => {
 ...
 */
const normalizeSchemaPath = (schemaPath, configPath) => {
    if (schemaPath == null) {
        return undefined;
    }
 ...
 */
export const getSchemaPathFromPrismaConfig = async (startDir) => {
