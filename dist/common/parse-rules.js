import { getRuleConfig, getRuleLevel, } from '#src/common/config.js';
export const parseRules = (ruleDefinitions, rootConfig) => {
    const rules = [];
    const parseIssues = [];
    ...
    const ruleDefinitionMap = new Map(ruleDefinitions.map((d) => [d.ruleName, d]));
